...
# Bridge Container
./start ros-jazzy-ros1-bridge-builder:latest --name ros1_bridge --homedir ./Bridge_Projects/ --rosip 10.104.144.3 --rosmasteruri http://10.104.144.3:11311 --extra "-e ROS_DOMAIN_ID=10"
